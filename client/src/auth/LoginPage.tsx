...
const LoginPage: React.FC = () => {
  ...
  const renderInput = (
    ...
    >
      <motion.label
        htmlFor={name}
        className={`block text-sm font-medium mb-2 transition-colors duration-200 ${focusedField === name ? 'text-purple-700' : 'text-slate-800'
          }`}
        ...
        <Controller
          ...
          render={({ field }) => (
            <motion.input
              ...
              className={`w-full px-5 py-4 bg-white/20 backdrop-blur-md border-2 rounded-2xl transition-all duration-300 ease-out ${errors[name]
                  ...
                  : focusedField === name
                    ...
                    : watchedValues[name]
                      ...
                      : 'border-slate-200 hover:border-slate-300 hover:bg-white/25 shadow-sm hover:shadow-md'
  ...
  const renderPasswordInput = () => (
    ...
    >
      <motion.label
        htmlFor="password"
        className={`block text-sm font-medium mb-2 transition-colors duration-200 ${focusedField === 'password' ? 'text-purple-700' : 'text-slate-800'
          }`}
        initial={{ opacity: 0, x: -10 }}
        animate={{ opacity: 1, x: 0 }}
      ...
      <motion.div className="relative group">
        <Controller
          ...
          render={({ field }) => (
            <motion.input
              ...
              disabled={isSubmitting}
              className={`w-full px-5 py-4 pr-16 bg-white/20 backdrop-blur-md border-2 rounded-2xl transition-all duration-300 ease-out ${errors.password
                  ? 'border-red-400 focus:border-red-500 focus:ring-4 focus:ring-red-500/20 bg-red-50/20 shadow-lg'
        ...
        <motion.button
          type="button"
          className={`absolute right-4 top-1/2 -translate-y-1/2 w-9 h-9 p-2 rounded-xl transition-all duration-200 z-20 flex items-center justify-center ${focusedField === 'password'
              ? 'bg-white/30 backdrop-blur-md border border-purple-300 shadow-sm'
              : 'bg-white/20 backdrop-blur-sm border border-slate-200 hover:bg-white/30 hover:border-slate-300 shadow-sm'
            }`}
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-slate-50 to-slate-100">
        ...
        <motion.div
          className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-purple-100/40 to-purple-200/20 rounded-full"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 180, 360],
            x: [0, 50, 0],
        ...
        />
        <motion.div
          className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-slate-200/30 to-purple-100/20 rounded-full"
          animate={{
            scale: [1.1, 1, 1.1],
            rotate: [360, 180, 0],
            x: [0, -50, 0],
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <motion.h2
                className="text-3xl font-bold mb-3 bg-gradient-to-r from-slate-900 to-purple-700 bg-clip-text text-transparent"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <motion.p
                className="text-slate-700 text-sm mb-4 font-medium"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8" noValidate>
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        animate={{
                          ...
                          borderColor: field.value ? '#a855f7' : '#cbd5e1'
                        }}
                        transition={{ duration: 0.2 }}
                      >
                        <AnimatePresence>
                      ...
                      <span className="text-sm font-medium text-slate-700 group-hover:text-purple-700 transition-colors duration-200">
                        Remember me
                      </span>
                    </motion.label>
                  )}
              ...
              >
                <motion.button
                  type="submit"
                  className={`w-full relative overflow-hidden px-8 py-4 rounded-2xl font-semibold text-base transition-all duration-300 shadow-lg ${isValid && !isSubmitting
                      ...
                      : 'bg-slate-300/50 text-slate-500 cursor-not-allowed shadow-slate-200/25'
                    } disabled:opacity-60`}
          ...
          {/* Decorative Elements */}
          <motion.div
            className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-purple-100/15 to-transparent rounded-full pointer-events-none"
            animate={{
              scale: [1, 1.1, 1],
              rotate: [0, 90, 0]
            }}
          ...
          />
          <motion.div
            className="absolute -bottom-20 -left-20 w-32 h-32 bg-gradient-to-tr from-slate-200/15 to-transparent rounded-full pointer-events-none"
            animate={{
              scale: [1.1, 1, 1.1],
              rotate: [0, -90, 0]
            }}
