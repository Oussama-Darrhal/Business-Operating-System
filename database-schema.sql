...
-- Supports Multi-Tenancy, Inventory Management, and Complaint/Review Management

-- ================================
-- CORE SYSTEM TABLES
-- ================================

-- SMEs (Small and Medium Enterprises) - Tenant Management
CREATE TABLE smes (
...
-- Users (Multi-tenant users across SMEs)
CREATE TABLE users (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    UNIQUE KEY unique_email_per_sme (sme_id, email),
    INDEX idx_user_sme (sme_id),
...
CREATE TABLE industry_benchmarks (
    ...
    period_value VARCHAR(20) NOT NULL, -- e.g., '2024-Q1', '2024-01'
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE products (
    ...
    local_category VARCHAR(100), -- SME-specific category
    brand VARCHAR(100),
...
CREATE TABLE inventory_stock (
    ...
    quantity_reserved DECIMAL(15,4) DEFAULT 0, -- Reserved for orders
...
CREATE TABLE review_sources (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(100) NOT NULL UNIQUE, -- e.g., 'Google Reviews', 'Facebook', 'Yelp'
...
CREATE TABLE customer_reviews (
    ...
    external_review_id VARCHAR(255), -- ID from the external platform
...
CREATE TABLE ai_analysis_results (
    ...
    confidence_score DECIMAL(5,4), -- Range: 0.0 to 1.0
    keywords JSON, -- Extracted keywords as JSON array
    topics JSON, -- Identified topics as JSON array
    emotions JSON, -- Detected emotions (joy, anger, sadness, etc.)
    language_code VARCHAR(10), -- e.g., 'en', 'es', 'fr'
    analysis_model VARCHAR(100), -- e.g., 'google-cloud-language-v1'
...
CREATE TABLE activity_logs (
    ...
    action VARCHAR(100) NOT NULL, -- e.g., 'create_product', 'update_inventory'
    entity_type VARCHAR(100), -- e.g., 'product', 'review', 'order'
...
-- ================================
-- INITIAL REVIEW SOURCES DATA
-- ================================

INSERT INTO review_sources (name, is_active) VALUES
('Google Reviews', TRUE),
...
INSERT INTO global_product_categories (name, description, level) VALUES
