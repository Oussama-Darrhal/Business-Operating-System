-- Business Operating System (BOS) Database Schema - Safe Version
-- Compatible with MySQL 8.0 and existing Laravel tables
...
-- Add foreign key for global_product_categories self-reference
ALTER TABLE global_product_categories 
ADD CONSTRAINT fk_global_categories_parent 
